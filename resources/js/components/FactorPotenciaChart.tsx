...
export default function FactorPotenciaChart({ datos, num_fases = 1, colores_canales = [] }: Props) {
        ...
        return (
            <div className="flex h-64 items-center justify-center rounded-lg border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    No hay datos de Factor de Potencia (cos φ) disponibles
                </p>
            </div>
        );
    }
    ...
    if (num_fases === 3) {
        datasets.push(
            {
                label: 'Fase 1 (PF)',
                data: datosFiltrados.map((d) => (d.factor_potencia_1 ?? 0)),
            ...
            {
                label: 'Fase 2 (PF)',
                data: datosFiltrados.map((d) => (d.factor_potencia_2 ?? 0)),
            ...
            {
                label: 'Fase 3 (PF)',
                data: datosFiltrados.map((d) => (d.factor_potencia_3 ?? 0)),
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function (context) {
                        ...
                        return `${context.dataset.label}: ${value.toFixed(2)} cos(φ)`;
                    },
                },
            },
        },
