...
interface DatosGrafica {
    fecha: string;
    corriente_canal_1?: number;
    corriente_canal_2?: number;
    corriente_canal_3?: number;
}
...
export default function CorrienteFasesChart({ datos, num_fases = 1, colores_canales = [] }: Props) {
        ...
        return (
            <div className="flex h-64 items-center justify-center rounded-lg border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    No hay datos de Corriente (Intensidad) disponibles
                </p>
            </div>
        );
    }
        ...
        datasets.push(
            {
                ...
                data: datosFiltrados.map((d) => (d.corriente_canal_1 ?? 0)),
            ...
            {
                label: 'Fase 2 (Amperaje)',
                data: datosFiltrados.map((d) => (d.corriente_canal_2 ?? 0)),
            ...
            {
                label: 'Fase 3 (Amperaje)',
                data: datosFiltrados.map((d) => (d.corriente_canal_3 ?? 0)),
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function (context) {
                        ...
                        return `${context.dataset.label}: ${value.toFixed(2)} Amperios`;
                    },
                },
            },
        },
