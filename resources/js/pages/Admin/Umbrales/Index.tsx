...
function UmbralModal({
    ...
    const form = useForm({
        ...
        dias_semana: umbral?.dias_semana ?? [
            'lun',
            'mar',
            'mie',
            'jue',
    ...
    const addEmail = () => {
        ...
        if (email && !form.data.destinatarios_email.includes(email)) {
            form.setData('destinatarios_email', [
                ...form.data.destinatarios_email,
                email,
            ]);
            setNuevoEmail('');
        }
    ...
    const removeEmail = (email: string) => {
        form.setData(
            'destinatarios_email',
            form.data.destinatarios_email.filter((e) => e !== email),
        );
    };
    ...
    const toggleOrg = (orgId: number) => {
        ...
        if (current.includes(orgId)) {
            ...
            const dispositivo_ids = form.data.dispositivo_ids.filter(
                (deviceId) => {
    ...
    const toggleDispositivo = (dispositivoId: number) => {
        ...
        if (current.includes(dispositivoId)) {
            form.setData(
                'dispositivo_ids',
                current.filter((id) => id !== dispositivoId),
            );
        } else {
    ...
    const dispositivosFiltrados = dispositivos.filter(
        (dispositivo) =>
            dispositivo.organizacion_id !== null &&
            form.data.organizacion_ids.includes(dispositivo.organizacion_id),
    );
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>
                        {isEditing ? 'Editar Umbral' : 'Nuevo Umbral'}
                    </DialogTitle>
                    <DialogDescription>
                        {isEditing
                            ? 'Modifica la configuracion del umbral.'
                            : 'Define un nuevo umbral de funcionamiento.'}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-8 pt-4 pb-6">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-1">
                            <Label>Metrica</Label>
                            <Select
                                value={form.data.metrica}
                                onValueChange={(v) =>
                                    form.setData('metrica', v)
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div className="space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    form.setData('valor_minimo', e.target.value)
                                }
                        ...
                        <div className="space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    form.setData('valor_maximo', e.target.value)
                                }
                                placeholder="Dejar vacio si no aplica"
                            />
                        </div>
                        <div className="space-y-1">
                            ...
                            <Select
                                value={form.data.severidad}
                                onValueChange={(v) =>
                                    form.setData('severidad', v)
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-400">
                            El umbral solo se evaluara dentro de este horario.
                            Por defecto 24h.
                        </p>
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {[
                                    ...
                                    const activo =
                                        form.data.dias_semana.includes(dia.key);
                    ...
                    {(() => {
                        ...
                        else if (soloLaborables)
                            diasTexto = 'De lunes a viernes';
                        else if (soloFinDeSemana) diasTexto = 'Fines de semana';
                        else if (dias.length > 0)
                            diasTexto = dias
                                .map((d) => diasLabels[d] || d)
                                .join(', ');

                        const horarioTexto = es24h
                            ? '24 horas'
                            : `de ${hi} a ${hf}`;
                        ...
                        return (
                            ...
                            >
                                <p
                                    className={`text-sm ${dias.length === 0 ? 'text-red-800' : 'text-blue-800'}`}
                                >
                                    <span className="font-medium">Activo:</span>{' '}
                                    {dias.length === 0
                                        ? 'No se evaluara (ningun dia seleccionado)'
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <label className="flex cursor-pointer items-center gap-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(v) =>
                                        form.setData('notificar_email', !!v)
                                    }
                                />
                            ...
                            <label className="flex cursor-pointer items-center gap-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(v) =>
                                        form.setData('notificar_telegram', !!v)
                                    }
                                />
                        ...
                        <div className="space-y-2">
                            ...
                            {form.data.destinatarios_email.length > 0 && (
                                <div className="mt-2 flex flex-wrap gap-2">
                                    {form.data.destinatarios_email.map(
                                        (email) => (
                                            <span
                                                key={email}
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-400">
                            Selecciona las organizaciones donde se aplicara este
                            umbral.
                        </p>
                        <div className="grid max-h-48 grid-cols-1 gap-2 overflow-y-auto rounded-lg border p-3 sm:grid-cols-2">
                            {organizaciones.map((org) => (
                                ...
                                >
                                    <Checkbox
                                        checked={form.data.organizacion_ids.includes(
                                            org.id,
                                        )}
                                        onCheckedChange={() =>
                                            toggleOrg(org.id)
                        ...
                        <div className="grid max-h-56 grid-cols-1 gap-2 overflow-y-auto rounded-lg border p-3">
                            {dispositivosFiltrados.length === 0 ? (
                                ...
                                dispositivosFiltrados.map((dispositivo) => (
                                    <label
                                        key={dispositivo.id}
                                        className="flex cursor-pointer items-start gap-2 rounded p-1.5 hover:bg-gray-50"
                                    >
                                        <Checkbox
                                            checked={form.data.dispositivo_ids.includes(
                                                dispositivo.id,
                                            )}
                                            onCheckedChange={() =>
                                                toggleDispositivo(
                                        ...
                                        <div className="flex flex-col text-sm">
                                            ...
                                            <span className="text-xs text-gray-400">
                                                {
                                                    dispositivo.organizacion_nombre
                                                }{' '}
                                                / {dispositivo.sitio_nombre}
                                            </span>
                                        </div>
                                    </label>
                                ))
                ...
                <DialogFooter>
                    ...
                    <Button
                        ...
                        disabled={form.processing || !form.data.nombre}
                    >
...
export default function UmbralesIndex({
    umbrales,
    organizaciones,
    dispositivos,
    metricas,
    ...
    const handleDelete = (umbral: Umbral) => {
        if (confirm(`Eliminar el umbral "${umbral.nombre}"?`)) {
            router.delete(`/admin/umbrales/${umbral.id}`, {
                preserveScroll: true,
            });
        }
    };
    ...
    const handleToggle = (umbral: Umbral) => {
        router.post(
            `/admin/umbrales/${umbral.id}/toggle-activo`,
            {},
            { preserveScroll: true },
        );
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Define rangos aceptables para metricas electricas y
                            configura alertas
                        </p>
                    </div>
                ...
                <Card>
                    ...
                    <CardContent className="mt-3 p-0">
                        <div className="hidden grid-cols-8 gap-2 border-y bg-gray-100 px-4 py-2 text-xs font-medium tracking-wider text-gray-500 uppercase sm:grid">
                            <span>Nombre</span>
                            <span>Metrica</span>
                            <span>Rango</span>
                            <span>Severidad</span>
                        ...
                        {umbrales.length === 0 ? (
                            ...
                            umbrales.map((umbral) => {
                                ...
                                const sev =
                                    severidadConfig[umbral.severidad] ||
                                    severidadConfig.warning;
                                    ...
                                    >
                                        <div className="grid grid-cols-1 items-center gap-2 px-4 py-5 sm:grid-cols-8">
                                            <div className="flex items-center gap-2">
                                                <div
                                                    className={`h-2 w-2 flex-shrink-0 rounded-full ${umbral.activo ? 'bg-green-500' : 'bg-gray-300'}`}
                                                />
                                            ...
                                            <span
                                                className={`inline-flex w-fit items-center rounded-full px-2 py-0.5 text-xs font-medium ${sev.color}`}
                                            >
                                            ...
                                            <div className="flex gap-1.5">
                                                ...
                                                {umbral.notificar_telegram && (
                                                    <span className="rounded bg-cyan-100 px-1.5 py-0.5 text-[10px] text-cyan-600">
                                                        TG
                                                    </span>
                                                )}
                                                {!umbral.notificar_app &&
